...
//     // This map keeps track of the possible indices a particular node vale is found in the heap.Having this mapping lets
//     // us have O(log(n)) removals and O(1) element containment check at the cost of some additional space and minor overhead

//     private Map <T,TreeSet<Integer>> map=new HashMap<>();

//     // Construct an intially empty priority queue
//     public PQueue(){
//         this(1);
//     }
...
//     // Construct a priority queue using heapify,O(n) time 
...
//     // Priority queue constructuons, O(nlog(n))
...
//     // Returns the value of the element with the lowest priority else null is returned if the queue is emptyy
//     public T peek(){
...
//         mapSwap(i_elem,j_elem,i,j);  // Overhead of the map
//     }
...
//         // both of its children left and right if they exists return false otherwise to indicate an invalid heap
